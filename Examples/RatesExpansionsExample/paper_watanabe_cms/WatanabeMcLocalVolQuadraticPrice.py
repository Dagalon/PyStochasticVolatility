...
for i in range(0, len(strikes)):
    ...
    diff_hagan_mc.append(mc_option_price[0] / hagan)
    ...
    diff_watanabe_mc.append(mc_option_price[0] / watanabe_price)
...
# plt.plot(strikes, limit, label='y=x', linestyle='dashdot', color='k')
# plt.scatter(strikes, diff_hagan_mc, label='hagan - mc price', s=8, color='y')
# plt.scatter(strikes, diff_watanabe_mc, label='watanabe - mc price', s=8, color='c')
