...
low_output_estimation = ToolsFBM.get_estimator_rs(np.diff(low_hurst_parameter_paths[0, :]), 5, 10)
...
medium_output_estimation = ToolsFBM.get_estimator_rs(np.diff(medium_hurst_parameter_paths[0, :]), 5, 10)
...
large_output_estimation = ToolsFBM.get_estimator_rs(np.diff(large_hurst_parameter_paths[0, :]), 5, 10)
