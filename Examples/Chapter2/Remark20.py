...
z_s, iv_fd = get_vetor_iv_cev(nu, alpha, T, f0)
z_s_up, iv_fd_up = get_vetor_iv_cev(nu, alpha, T, f0_up)
z_s_down, iv_fd_down = get_vetor_iv_cev(nu, alpha, T, f0_down)

plt.plot(z_s, iv_fd, label="f0=" + str(f0), linestyle='--', marker=styles[0], color='black')
plt.plot(z_s, iv_fd_up, label="f0=" + str(f0_up), linestyle='--', marker=styles[1], color='black')
plt.plot(z_s, iv_fd_down, label="f0=" + str(f0_down), linestyle='--', marker=styles[2], color='black')
