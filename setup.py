...
setup(
    ...
    packages=['Tools', 'Tools.VolatilityTools', 'Solvers', 'Solvers.ODE_Solver', 'Solvers.PDE_Solver',
              ...
              'MC_Engines.GenericSDE', 'MC_Engines.MC_RBergomi', 'MC_Engines.MC_ExpOUModels1F',
              'MC_Engines.MC_LocalVolEngine', 'Instruments', 'AnalyticEngines', 'AnalyticEngines.Expansions',
